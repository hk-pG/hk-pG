...
- **[sun-riseup-viewrrr](https://github.com/hk-pG/sun-riseup-viewrrr)**
  - Tauri + React で構築されたアプリケーション
  - アーキテクチャやテスト設計の実践の場として開発中
...
![CI/CD](https://img.shields.io/badge/-CI/CD-green?style=flat-square)

## 🌱 Currently Learning & Focusing
- **Application Architecture**: 長期開発に耐えうる堅牢な設計
- **Testing**: フロントエンド・バックエンド双方のテスト戦略
- **CI/CD**: 自動化による開発効率の向上
